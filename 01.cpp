//program to find the avg test score and output the
//avg test score and all the test scores that are
...
int main()
{
	...
	cout << "the avg test score is : " << average << endl;

	if (test0 < average)
		cout << test0 << " is less than the average ";
	if (test1 < average)
		cout << test1 << " is less than the avaregae";
	if (test2 < average)
		cout << test2 << "is less than the average";
	if (test3 < average)
		cout << test3 << "is less than the avaregae";
	if (test4 < average)
